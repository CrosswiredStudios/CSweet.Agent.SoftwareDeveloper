...
The package ID is `com.csweet.software-developer`; this initial implementation is version `0.1.0`
...
Built with `CSweet.Agent.SDK` 2.1.0 and `CSweet.WorkManagement.Contracts` 1.1.0.
